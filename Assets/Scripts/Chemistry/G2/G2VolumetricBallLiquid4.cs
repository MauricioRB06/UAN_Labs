...
//
// Set the behavior of the Volumetric Ball Liquid 4.
//
...
{
    public class G2VolumetricBallLiquid4 : MonoBehaviour
    {
        ...
        private void Awake()
        {
            StepManager.Instance.Counter
                ...
                .Subscribe(_ =>
                {
                    gameObject.GetComponent<Animator>().Play("VolumetricBall Liquid 4 Fill");
                });
        }
