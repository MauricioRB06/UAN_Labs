...
//
// Set the behavior of the Volumetric Ball Liquid 1.
//
...
{
    public class G2VolumetricBallLiquid1 : MonoBehaviour
    {
        ...
        private void Awake()
        {
            StepManager.Instance.Counter
                ...
                .Subscribe(_ =>
                {
                    gameObject.GetComponent<Animator>().Play("VolumetricBall Liquid 1 Fill");
                });
        }
