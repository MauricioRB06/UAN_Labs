...
//
// It establishes the behavior of onion wedge.
//
...
namespace Biology.G1
{
    ...
    public class G1OnionWedge : MonoBehaviour
    {
        
        [Space(2)]
        [Header("Step Settings")] [Space(5)]
        [SerializeField] private GameObject arrowObject;
        [Tooltip("Set the step at which the Onion Wedge will be enabled.")]
        [SerializeField] private List<int> stepsToEnable = new();
        [Tooltip("Set the step at which the Onion Wedge will be disable.")]
