...
//
// Sets the behavior of the object cover.
//
...
namespace Biology.G1
{
    ...
    public class G1ObjectCover : MonoBehaviour, IDraggable
    {
        
        [Space(2)]
        [Header("Step Settings")] [Space(5)]
        [SerializeField] private GameObject arrowObject;
        [Tooltip("Set the step at which the Object Cover will be enabled.")]
        [SerializeField] private List<int> stepsToEnable = new();
        [Tooltip("Set the step at which the Object Cover will be disable.")]
